    ...
    <div className="min-h-screen bg-[var(--bg-primary)] text-[var(--text-primary)] flex flex-col items-center justify-center p-6 selection:bg-[var(--accent)]/20 selection:text-[var(--accent)]">
      ...
      <div className="w-full max-w-sm bg-[var(--bg-surface)] p-8 rounded-xl border border-[var(--border)] shadow-2xl space-y-6">
        <div className="text-center space-y-1.5">
          <h1 className="text-2xl font-normal font-serif tracking-tight text-[var(--text-primary)]">Create Engram Account</h1>
          <p className="text-sm text-[var(--text-secondary)]">Join the active recall layer for AI engineers</p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-3">
          ...
          <button 
            type="submit"
            disabled={isLoading}
            className="w-full bg-[var(--accent)] hover:bg-[var(--accent-hover)] text-[#050505] py-2.5 px-4 rounded-full text-sm font-semibold tracking-tight transition-colors disabled:opacity-60 cursor-pointer shadow-xs mt-2"
          >
        ...
        <p className="text-center text-sm text-[var(--text-secondary)] pt-1">
          Already registered? <Link href="/login" className="text-[var(--accent)] hover:underline font-medium">Sign in</Link>
        </p>
      </div>
    </div>
  );
